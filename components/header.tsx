  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        border border-white border-opacity-60 bg-white bg-opacity-70 shadow-lg 
        shadow-black/[0.03] backdrop-blue-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] 
      ...
      >
        <ul
          className="flex w-[22rem] flex-wrap items-center justify-center gap-y-1 text-[0.9rem]
            font-bold text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5"
        >
          {links.map((link) => (
            <motion.li
